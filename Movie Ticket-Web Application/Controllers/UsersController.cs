...
namespace AspNetCoreTodo.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,Name,LastName,AvatarimgUrl")] Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("UserId,UserName,Name,LastName,AvatarimgUrl")] Users users)
        {
            if (id != users.UserId)
            {
                return NotFound();
